...
public class QualityControlInfo {
    ...
    public String toString() {
        return "QualityControlResults [passedReads=" + passedReads + ", aligned=" + aligned + ", paired=" + paired + ", totalCoverage="
                + totalCoverage + ", mean=" + mean + ", icSNPResultList=" + icSNPResultList + "]";
    }
