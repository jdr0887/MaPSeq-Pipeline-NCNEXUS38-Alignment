package edu.unc.mapseq.messaging.ncnexus38.alignment;
...
public class NCNEXUS38AlignmentMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUS38AlignmentMessageListener.class);

    public NCNEXUS38AlignmentMessageListener() {
        super();
    }
